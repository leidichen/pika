                        ...
                        <div className="">
                            ...
                            <div className="grid flex-wrap grid-cols-6 mt-1 gap-x-4 gap-y-2">
                                {[
                                    ...
                                    "bg-white",
                                    "bg-black",
                                    "bg-gradient-to-br from-#030e26 to-#030e26",
                                ].map((theme) => (
                                    <div
                                        key={theme}
                            ...
                            >
                                <div
                                    ...
                                    style={
                                        options?.customTheme
                                            ? {
                                                background: `linear-gradient(45deg, ${options?.customTheme?.colorStart || "transparent"
                                ...
                                >
                                    ...
                                    <img
                                        ...
                                        className={`relative z-10s transition-all duration-200 ease-in-out ${options?.shadow
                                            } ${options?.rounded} ${getImageRadius()} ${options?.browserBar == "hidden" ? "" : "rounded-t-none"
                                            }`}
                                        onLoad={(e) => {
                                            setBlob({
                                                ...blob,
